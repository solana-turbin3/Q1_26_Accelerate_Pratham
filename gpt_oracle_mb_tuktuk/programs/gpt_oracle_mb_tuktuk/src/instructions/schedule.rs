    ...
    pub fn schedule(&self, task_id: u16, bumps: &ScheduleBumps) -> Result<()> {
        ...
        queue_task_v0(
            ...
            tuktuk_program::types::QueueTaskArgsV0 {
                ...
                free_tasks: 0,
                description: "ask_oracle".to_string(),
            },
        )?;

        msg!("Task scheduled via TukTuk!");
        Ok(())
    }
}
